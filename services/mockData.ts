...
export const mockGroup: Group = {
  ...
  user: {
    ...
    batteryPercent: 92,
    status: 'with_group',
    // Anchor at the centre of the map. The mock location engine drifts
    // this value subtly over time; the canvas re-centres on the user
    // each frame so they always render at the optical centre.
  ...
  members: [
    {
      ...
      position: { x: 0.66, y: 0.22 },
      lastSeenPlace: 'House of Yes, Brooklyn',
      distanceFromGroupMiles: 0.02,
      device: 'iPhone 15',
    },
    {
      id: 'f_maya',
    ...
    },
    {
      ...
      batteryPercent: 85,
      lastSeenMinutesAgo: 0,
      position: { x: 0.18, y: 0.6 },
      lastSeenPlace: 'House of Yes, Brooklyn',
      distanceFromGroupMiles: 0.03,
